...
def test_home(page: Page, live_server_url: str):
    ...
    expect(page).to_have_title("Human Resource Assistant | GPT + Enterprise data")
...
def test_chat(page: Page, live_server_url: str):
    ...
    page.get_by_placeholder("Type a new question (e.g. what are my leave entitlements as a full-time employee?)").click()
    page.get_by_placeholder("Type a new question (e.g. what are my leave entitlements as a full-time employee?)").fill(
...
def test_ask(page: Page, live_server_url: str):
    ...
    page.get_by_placeholder("Example: what are my leave entitlements as a full-time employee?").click()
    page.get_by_placeholder("Example: what are my leave entitlements as a full-time employee?").fill("Whats the dental plan?")
    page.get_by_placeholder("Example: what are my leave entitlements as a full-time employee?").click()
    page.get_by_label("Ask question button").click()
